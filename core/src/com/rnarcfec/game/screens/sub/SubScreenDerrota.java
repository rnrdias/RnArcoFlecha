 ...
 * @author RNR
 */
public class SubScreenDerrota extends AbstractSubScreen{
    ...
    public SubScreenDerrota(RnArcFecGame game) {
        super(game);
        ...
        titulo = new Label(Linguagem.DERROTA, labelStyleTitulo);
        ...
        botaoContinuar = new ImageButton(new TextureRegionDrawable(Assets.instance.subTelaConfig.botaoTentarNovamente));
        botaoSair = new ImageButton(new TextureRegionDrawable(Assets.instance.subTelaConfig.botaoSair));
        textBotaoContinuar = new Label(Linguagem.TENTE_NOVAMENTE, labelStyleNum);
